...
sample_weapon = Melee(None, pygame.Vector2(0,0),SampleWeaponSprite, (10, 50), 30, 10)
...
sample_weapon2 = Melee(None, pygame.Vector2(0,0),SampleWeaponSprite, (10, 50), 30, 10)

def equip_weapon(player, weapon:Weapon):
    player.equip(weapon)