...
from game_engine.entities.entity import BiDirectionalEntity, Entity, EntityManager, Hitbox
...
class WeaponizedCharacter(Character):
  def __init__(self, image:pygame.Surface, position: pygame.Vector2, size: Size2D, speed: int, jump_power: int, weapon: Weapon=None):
      self._weapon = weapon
